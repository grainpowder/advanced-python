...
>> Problem(a.k.a. when to use)
    There is an additional feature, denoted as A, that has to be added to each of implemented function, F1, F2, ..., F100

>> Possible Solution
    1. Modify each of F1, F2, ..., F100 or create another 100 functions G1, G2, ..., G100
        -> Unarguably inefficient.
    2. Make a function B that takes function and required argument as input and operates A
...
>> Example
    1. Ridiculous sqrt function is defined in global scope, but this is not referred by main function inside get_l2norm thanks to scoping rule.
        -> Ambiguity of 'sqrt' is avoided!
    2. To understand how main function works in each decorator, note that meaning of asterisks in...
